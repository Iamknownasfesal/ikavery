          ...
          <div className="col-span-12 lg:col-span-7 lg:order-1">
            ...
            <Reveal delay={0.22}>
              <p className="mt-6 sm:mt-7 max-w-[480px] text-[15px] sm:text-[17px] leading-[1.6] text-text-2">
                A demo of one approach to quorum-gated key custody on{" "}
                <span className="text-text">Solana</span>. Splits a private key
                across the wallets of the people you already trust, lets any
                quorum sign on demand. Runs on{" "}
                <span className="text-text">Ika 2PC-MPC</span>. The purpose is
                to show, not to ship.
              </p>
            </Reveal>
            <Reveal delay={0.34}>
  ...
  threshold: { k: 3, of: 5 },
          ...
          <Tile span={{ col: 2 }}>
            ...
            <div className="font-display text-[32px] leading-[1.05] tracking-[-0.02em] text-text">
              <span className="text-text-3 italic">None.</span> The Solana
              program verifies a wallet signature directly, on-chain.
            </div>
