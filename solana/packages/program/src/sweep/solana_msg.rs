...
impl<'a> ParsedMessage<'a> {
    ...
    pub fn account_at_index(&self, idx: u8) -> Option<&'a [u8; PUBKEY_LEN]> {
        ...
        let array: &'a [u8; PUBKEY_LEN] =
            <&[u8; PUBKEY_LEN]>::try_from(slice).ok()?;
        Some(array)
    }
...
mod tests {
    ...
    const TRANSFER_FIXTURE: &[u8] = &[
        ...
        // header
        0x01, 0x00, 0x01,
        // 3 account keys (shortvec count = 3)
        0x03,
        // account[0] = from
        ...
        0x29, 0x9c,
        // account[2] = SystemProgram (zero pubkey)
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00,
        // recent blockhash (placeholder 0x33...)
        ...
        0x02,
        // ix accounts shortvec count = 2, then [0, 1]
        0x02, 0x00, 0x01,
